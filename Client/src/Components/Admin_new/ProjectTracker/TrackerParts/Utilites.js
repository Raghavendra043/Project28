                ...
                <div className={styles.list}>
                    <div className={styles.box}>
                        ...
                        <div className={styles.action}>
                            ...
                            <div className={styles.button_cover}>
                                <button onClick={giveHandler} className={classnames(styles.button,styles.hello)}>Give Feedback</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="projectModalView" class={styles.modal}>
                <div class={styles.modal_content}>
                    ...
                    <div className={styles.feedback_box}>
                        <input type='text' className={styles.feedback} name='view_feedback'/>
                        <div className={styles.button_cover}>
                                <button className={classnames(styles.button)}>Feedback</button>
                        </div>
                    </div>
                    <div className={styles.confirm_cover}>
                        <button className={classnames(styles.button,styles.confirm)}>Confirm</button>
                    </div>
                </div>
            </div>
