        ...
        <div className={e_style.page}>
          ...
          <div className={e_style.box} style={{ borderTop: "3px solid #00B4B3" }}>
            ...
            <div className={e_style.data}>
              ...
              <div className={classnames(styles.input_cover,e_style.input_cover)}>
                ...
                <div className={styles.resume_input_cover}>
                        <input type='text' className={styles.profile_input} placeholder="Link to you website / behance  / google drive etc. "/>
                    </div>
              </div>
