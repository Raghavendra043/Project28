      ...
      <div className="box2 upper">
        <div className="topsecond">
          <div className="headerSecond">
            Project Brief stage {formData.onCurrent}
          </div>
          <div className="logo">
            <svg
              width="17"
            ...
            >
              <path
                d="M5.77637 10.7241L8.50204 13.5001L11.2277 10.7241"
                stroke="#1E1F1E"
                stroke-width="1.25"
